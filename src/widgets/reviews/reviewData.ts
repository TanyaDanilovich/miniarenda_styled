export const reviewsData = [
    {
        ...
        reviewContent: "Пользовался услугами Александра несколько раз. Бурили сваи под фундамент, копали траншеи под фундамент. \
    ...
    {
        userName: "Argegat32",
        reviewContent: "Нужно было закрутить 6 винтовых свай. Связался с Александром в 20: 00 вечером в среду, в четверг  \
    ...
    },
    {
        ...
        reviewContent: "С Александром работаем достаточно давно. Всегда быстрое реагирование на заявки, качественная работа  \
    ...
    },
    {
        ...
        reviewContent: "Прикладывали сети, делали фундаменты под рекламные конструкции, \
    ...
    },
    {
        ...
        reviewContent: "Обращался для помощи в подготовке участка к монтажу свайной ленты для \
    ...
    },
    {
        ...
        reviewContent: "Пользовался услугами данной компании. Заказывал мини-экскаватор с \
    ...
    },
    {
        ...
        reviewContent: "Заказывали миниэкскаватор с ямобуром. Александр приехал вовремя, как \
    ...
    },
    {
        ...
        reviewContent: "Часто обращаюсь к Александру по вопросу проведения земляных работ. \
	Всегда работы выполняются качественно, оперативно. Цена адекватная.Спасибо за работу.Рекомендую",
    },
    {
        userName: "Наталья Котова",
        reviewContent: "Работала с этой организацией не один раз. Хочу отметить качество \
    ...
    },
    {
        ...
        reviewContent: "Обратились через интернет и остались очень довольны работой \
    ...
    },
    {
        ...
        reviewContent: "Рекомендую! Не смотря на тот что в земле было много железа, и мусора.\
	Отверстия под сваи, сделали быстро и качественно! Спасибо!",
    },
    {
        userName: "Нестеренко Павел",
        reviewContent: "Сами монолитчики, работаем с этой командой регулярно, качественное \
	обслуживание, адекватные цены, пунктуальность. Рекомендуем.",
    },
    {
        userName: "Michail Bak",
        reviewContent: "Спасибо за оперативность. Все пробурили очень быстро, а самое главное \
	недорого!!! Рекомендую!!!!",
    },
    {
        userName: "Александр Сергеев",
        reviewContent: "Отличные операторы. Пользуюсь давно. Много навесного",
    },
];